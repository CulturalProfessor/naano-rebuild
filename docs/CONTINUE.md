...
Paste everything below the line into a new session, from this repo.

---

We are rebuilding naano.com in 24 hours as a hiring assignment for 8x. naano is a
B2B LinkedIn creator marketplace: brands find vetted creators, brief them, track
posts through clicks and leads to pipeline, and pay them out. Creators build a
marketplace card, accept or decline deals, post, and get paid.

Judged on three things: how much working product exists at the end, the product
judgement behind what got built first and what got left out, and whether the
thing is good to use. A stranger must be able to hit the live URL, sign up with
